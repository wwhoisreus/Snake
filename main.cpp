...
int main()
{
    ...
    Texture t;
    t.loadFromFile("C:/Users/User/CLionProjects/untitled/block.png");
    Sprite tiles(t);

    //Ставим картинку змейки
    Texture sn;
    sn.loadFromFile("C:/Users/User/CLionProjects/untitled/snake.png");
    Sprite snake(sn);

    //Ставим картинку яблоко
    Texture ap;
    ap.loadFromFile("C:/Users/User/CLionProjects/untitled/apple.png");
    Sprite apple(ap);

    //Ставим надпись gameover
    Texture go;
    go.loadFromFile("C:/Users/User/CLionProjects/untitled/gameover.png");
    Sprite gameover(go);
    ...
    Clock clock; //переменная clock нужна для игрового времени
